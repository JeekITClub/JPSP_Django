...
urlpatterns=[
    ...
    url(r'^club/recruit/classroom/ApplySubmit', views.club_recruit_classroom_apply_submit,name="ClubRecruitClassroomApplySubmit"),
    url(r'^cd/recruit/classroom/Apply/Verify', views.cd_recruit_classroom_apply_verify_submit,name="CDRecruitClassroomApplyVerifySubmit"),
